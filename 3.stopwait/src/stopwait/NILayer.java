...
public class NILayer implements BaseLayer {
	...
	public void SetAdapterList() {
		// 占쏙옙占쏙옙 占쏙옙퓨占싶울옙 占쏙옙占쏙옙占싹댐옙 占쏙옙占� 占쏙옙트占쏙옙크 占쏘뎁占쏙옙 占쏙옙占� 占쏙옙占쏙옙占쏙옙占쏙옙
		int r = Pcap.findAllDevs(m_pAdapterList, errbuf);
		System.out.println("I/F 媛��닔: "+m_pAdapterList.size());
		// 占쏙옙트占쏙옙크 占쏘뎁占싶곤옙 占싹놂옙占쏙옙 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占� 占쏙옙占쏙옙 처占쏙옙
		if (r == Pcap.NOT_OK || m_pAdapterList.isEmpty())
			System.out.println("[Error] 占쏙옙트占쏙옙크 占쏙옙占쏙옙拷占� 占쏙옙占쏙옙 占쏙옙占싹울옙占쏙옙占싹댐옙. Error : " + errbuf.toString());
	}
