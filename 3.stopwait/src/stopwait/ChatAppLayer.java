...
public class ChatAppLayer implements BaseLayer {
    ...
    /////////怨쇱젣 �걹 遺�遺�//////////
    	...
    	/* �떒�렪�솕 �븳 �떎�쓬 10 諛붿씠�듃 �뵫 �쟾�넚 
     	泥ル쾲吏� �뜲�씠�꽣�뒗 0x01 濡� type�쓣 蹂대궦�떎.
      	留덉�留됱뿉�뒗 type�쓣 0x03 �쑝濡� 諛붽씀怨�
       	以묎컙�뜲�씠�꽣�뿉�뒗 type�쓣 0x02濡� 遺숈뿬�꽌 蹂대궦�떎.*/
        ...
        if(tempType == 0) {
        	...
        	if(tempType == 1){
        		...
        		System.arraycopy(tempBytes, 0, fragBytes, 
        				(fragCount++) * 10, byte2ToInt(input[0], input[1]));
        		if(tempType == 3){
